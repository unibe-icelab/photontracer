...
(Not published yet) Prebuilt wheels for photontracer are available on PyPI for Windows and Linux. Activate your Python environment and install with pip:
```bash
pip install photontracer
```
